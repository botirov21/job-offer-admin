...
export default function OrderTableq() {
    ...
    <>
      ...
      >
        <FormControl sx={{ flex: 1 }} size="sm">
          ...
          <FormLabel>
            There are {allData.length} jobs are available
          </FormLabel>
          <Input
            size="sm"
            placeholder="Search"
                        ...
                        <ModalDialog>
                          ...
                          >
                            <Stack spacing={2} sx={{ p: 2,  display: 'flex' , flexDirection: 'row' }}>
                              ...
                              <Button onClick={ ()=> {handleUpdate(data._id); console.log(data._id, "data id")}}  type="submit" color="success">
                                Edit
                              </Button>
                              <Button
                                onClick={() => {
